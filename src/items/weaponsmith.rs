...
pub const HALBERD: ItemRef = ItemRef::new("halberd", 30, &[Prop::Damage(3), Prop::Bulky(2)]);
pub const ZWEIHANDER: ItemRef = ItemRef::new("zweihander", 30, &[Prop::Damage(3), Prop::Bulky(2)]);

pub const LONGBOW: ItemRef = ItemRef::new(
    "longbow",
    30,
    &[Prop::Damage(2), Prop::Range(120), Prop::Bulky(2)],
);
